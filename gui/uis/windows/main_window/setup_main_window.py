...
from gui.widgets.c_controller_layout import ControllerLayoutWidget # Import the custom controller widget - SB
...
class SetupMainWindow:
    def __init__(self):
        ...
        self.ui.load_pages = self.ui.pages
    ...
    add_left_menus = [
        ...
        {
            "btn_icon": "Calibrate_small.svg",
            "btn_id": "btn_home2",
            "btn_text": "calibration",
            "btn_tooltip": "Needle calibration",
            "show_top": True,
            "is_active": False,
        },
        {
            "btn_icon": "MakePrint_small.svg",
            "btn_id": "btn_home3",
            "btn_text": "Make Print",
            "btn_tooltip": "Make a print file",
            "show_top": True,
            "is_active": False,
        },
        {
            "btn_icon": "PrintSetup_small.svg",
            "btn_id": "btn_home4",
            "btn_text": "Setup Print",
            "btn_tooltip": "Setup the print files",
            "show_top": True,
            "is_active": False,
        },
        {
            "btn_icon": "3DPrint_small.svg",
            "btn_id": "btn_home5",
            "btn_text": "Run Print",
            "btn_tooltip": "Run and monitor the print",
            "show_top": True,
            "is_active": False,
        },
        ...
        {
            "btn_icon": "Xbox_small.svg",  
            "btn_id": "btn_controller_layout",
            "btn_text": "Controller Mapping",
            "btn_tooltip": "Modify the controller mapping",
            "show_top": True,
            "is_active": False,
        },
    ...
    def page6(self):        
        # Create an instance of your custom ControllerLayoutWidget
        controller_layout_widget = ControllerLayoutWidget()
        
        # Add it to the layout defined in your autogenerated UI file
        self.ui.load_pages.page_6_layout.addWidget(controller_layout_widget)
