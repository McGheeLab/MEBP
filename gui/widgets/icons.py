...
_ICONS: dict[str, str] = {
    ...
    # ── hand (pan / grab tool) ────────────────────────────────
    "hand": _icon(
        '<path d="M188,48a27.75,27.75,0,0,0-12,2.71V44a28,28,0,0,0-54.65-8.6A28,28,0,0,0,80,60v64l-3.82-6.13a28,28,0,0,0-48.6,27.82c.12.27.26.54.4.79l29.78,52.4A88,88,0,0,0,134.33,248H136a80.09,80.09,0,0,0,80-80V76A28,28,0,0,0,188,48Z"/>'
    ),
    # ── ruler (calibrate) ─────────────────────────────────────
    "ruler": _icon(
    ...
    # ── incubator (thermometer, v7.18) ───────────────────────
    "incubator": _icon(
        '<rect x="104" y="16" width="48" height="152" rx="24"/>'
        '<circle cx="128" cy="192" r="48"/>'
        '<rect x="164" y="48" width="36" height="16" rx="8"/>'
        '<rect x="164" y="88" width="36" height="16" rx="8"/>'
    ),
    # ── camera ────────────────────────────────────────────────
    "camera": _icon(
    ...
    # ── flask (Simulate / virtual hardware) ────────────────────
    # v7.4.2: per-stage Simulate buttons on Hardware Setup → Device
    # use this glyph to distinguish "open the simulator" from
    # "open real hardware" (which uses the `plug` glyph).
    "flask": _icon(
        '<path d="M224.16,212l-52-89.91V40h4a12,12,0,0,0,0-24H80a12,12,0,0,0,0,24h4v82.09L32,212a23.93,23.93,0,0,0,20.78,36H203.34A23.93,23.93,0,0,0,224.16,212ZM108,40h40v40H108Zm-2.55,64H150.6l24.27,42H81.13Z"/>'
    ),
    # ── cursor / pointer (Plate Designer Select tool) ─────────
    "cursor": _icon(
        '<path d="M221.66,165.66l-37.32,37.32A8,8,0,0,1,179,205a8.1,8.1,0,0,1-5.66-2.34l-37.13-37.13-29.79,53.62A8,8,0,0,1,99.41,224H99a8,8,0,0,1-7.13-5.69l-58-185.6A8,8,0,0,1,43.32,22.83l185.6,58a8,8,0,0,1,1.43,14.85l-53.62,29.79,37.13,37.13A8,8,0,0,1,221.66,165.66Z"/>'
    ),
    # ── grid (Plate Designer Grid tool) ───────────────────────
    "grid": _icon(
        '<path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40ZM104,200H40V152h64Zm0-64H40V112h64Zm0-40H40V56h64Zm56,104H120V152h40Zm0-64H120V112h40Zm0-40H120V56h40Zm56,104H176V152h40Zm0-64H176V112h40Zm0-40H176V56h40Z"/>'
    ),
    # ── circle-plus (Plate Designer Single Well tool) ─────────
    "circle-plus": _icon(
    ...
    # ── lock (fix constraint) ─────────────────────────────────
    "lock": _icon(
        '<path d="M208,80H176V56a48,48,0,0,0-96,0V80H48A16,16,0,0,0,32,96V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V96A16,16,0,0,0,208,80ZM96,56a32,32,0,0,1,64,0V80H96Zm44,128a4,4,0,0,1-4,4H120a4,4,0,0,1-4-4V160a4,4,0,0,1,4-4h16a4,4,0,0,1,4,4Z"/>'
    ),
    # ── compass (Plate Designer Circle Pattern tool) ─────────
    "compass": _icon(
        '<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm32.39,114.83-24,72a8,8,0,0,1-5,5l-72,24a8,8,0,0,1-10.13-10.13l24-72a8,8,0,0,1,5.06-5.06l72-24a8,8,0,0,1,10.13,10.13ZM128,120a8,8,0,1,0,8,8A8,8,0,0,0,128,120Z"/>'
    ),
    # ── line (Plate Designer Line tool) ───────────────────────
    "line": _icon(
        '<path d="M205.66,50.34a8,8,0,0,1,0,11.32l-144,144a8,8,0,0,1-11.32-11.32l144-144A8,8,0,0,1,205.66,50.34Z"/>'
        '<circle cx="56" cy="200" r="14"/>'
        '<circle cx="200" cy="56" r="14"/>'
    ),
    # ── undo / redo (Plate Designer history) ──────────────────
    "undo": _icon(
        '<path d="M88,104h88a48,48,0,0,1,0,96H120a8,8,0,0,1,0-16h56a32,32,0,0,0,0-64H88v32a8,8,0,0,1-13.66,5.66l-40-40a8,8,0,0,1,0-11.32l40-40A8,8,0,0,1,88,72Z"/>'
    ),
    "redo": _icon(
        '<path d="M168,104H80a48,48,0,0,0,0,96h56a8,8,0,0,0,0-16H80a32,32,0,0,1,0-64h88v32a8,8,0,0,0,13.66,5.66l40-40a8,8,0,0,0,0-11.32l-40-40A8,8,0,0,0,168,72Z"/>'
    ),
}
