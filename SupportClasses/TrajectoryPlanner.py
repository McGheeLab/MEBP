...
class TrajectoryPlanner:
    ...
    def plan_well_print(
        ...
        # v7.2.7: XY travel speed from workspace settings
        xy_travel_speed = self._settings.get("travel_speed_mm_s",
                            self._settings.get("xy_travel_speed_mm_s", 50.0))
