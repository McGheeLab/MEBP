...
def verify_api(content: str) -> list[str]:
    ...
    Uses 'def method_name(' to handle multiline signatures where
    'self' appears on the next line.
    """
    required = [
    ...
    for method in required:
        # Match 'def method_name(' — handles both single-line and multiline sigs
